...
export const competences = [
  ...
  // =========================================================================
  {
    ...
    ressources: [
      "R5.C.05 Nouvelles bases de données",
      "R5.C.06 Exploitation des bases de données",
      "R5.C.07 Données massives",
      "R5.C.08 Techniques d'IA",
      "R5.C.09 Statistique inférentielle",
      "R5.C.11 Optimisation des données dans le SI",
      "R6.C.05 Administration des bases de données",
      "R6.C.06 Aide à la décision",
    ],
    saes: ["S5.C.01 — Data mining", "S6.C.01 — Organisation & protection des données", "Stage / Alternance RATP"],
    autoPositionnement: {
      plage: "13 – 16",
      vers: "17 – 20",
      intitule: "Confirmé",
  ...
  // =========================================================================
  {
    ...
    ressources: [
      "R5.01 Initiation au management",
      "R5.03 Communication",
      "R5.C.10 Économie durable et numérique",
      "R6.01 Entrepreneuriat",
      "R6.02 Droit du numérique et propriété intellectuelle",
      "R6.03 Communication : information et transmission",
    ],
    saes: ["S5.C.01 — Data mining", "S6.C.01 — Organisation & protection des données", "Stage / Alternance RATP"],
    autoPositionnement: {
      plage: "13 – 16",
