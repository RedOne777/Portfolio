...
export default function ProjectCard({ projet: p }) {
  return (
    <article id={p.id} className="project-card flex h-full flex-col rounded-[18px] border border-line bg-surface p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_44px_-20px_rgba(20,24,40,0.25)]">
